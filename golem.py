...
bot = telebot.TeleBot('8057702686:AAHiVyd9bdhHzLWJ7CRBujAduJCmbQnKQi0')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                full_command = f"./golem {target_ip} {target_port} {duration} 800"
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name} get best rates from @GOLEM_OWNER'''
    bot.reply_to(message, response)
